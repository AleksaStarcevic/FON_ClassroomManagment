    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
               ...
               // .mvcMatchers().permitAll()
                .and()
                .authorizeRequests().mvcMatchers(APPOINTMENT_PREFIX+APPOINTMENT_CONFIRM,APPOINTMENT_PREFIX+APPOINTMENT_CONFIRM_ALL,USER_PREFIX+USER_REQUESTED_APPOINTMENTS).hasAuthority("ADMIN").and()
