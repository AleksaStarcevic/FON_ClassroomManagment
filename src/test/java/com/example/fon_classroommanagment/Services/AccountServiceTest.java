...
class AccountServiceTest {
    ...
    void createValidationToken_Pass() throws UserExistsExcetion {
        Account account=new Account("test@gmail.com","1234",null,"test","test");
    ...
    void createValidationToken_Fail() throws UserExistsExcetion {
        Account account=new Account("test@gmail.com","1234",null,"test","test");
        Account account2=new Account("threertg@gmail.com","1234",null,"test","test");
        ValidationToken toReturn=new ValidationToken("123456789",account);
        AccountService mock = Mockito.mock(AccountService.class);
        Mockito.when(mock.createValidationToken(account)).thenReturn(toReturn);
    ...
    void confirmAccount_Pass() throws TokenNotFaundException {
        ...
        ValidationToken VToken=new ValidationToken(token,new Account("test@gmail.com","1234",token));
        ...
        Employee employee=new Employee("test","test",new EmployeeDepartment(1L,"test"),new EducationTitle(1L,"test"),new EmployeeType(1L,"test"),"test@gmail.com",null);
    ...
    void confirmAccount_TokenExpiredException() throws TokenNotFaundException {
        String token = "123456789";
        ValidationToken VToken = new ValidationToken(token,  new Date( Calendar.getInstance().getTimeInMillis() + (EXPIRATION_TIME+1000)),new Account("test@gmail.com", "1234", null, token, "1234"));
