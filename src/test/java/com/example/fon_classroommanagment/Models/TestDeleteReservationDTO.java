...
public class TestDeleteReservationDTO extends  ModelTest<DeleteReservationDTO> {


    @Override
    @ParameterizedTest
    @MethodSource("generateValid")
    protected void TestValid(DeleteReservationDTO entity) {
    ...
    @ParameterizedTest
    @MethodSource("generateValid")
    protected void TestInvalid(DeleteReservationDTO entity) {
    ...
    private static Stream<Arguments> generateValid(){
        return  Stream.of(
                Arguments.of(new DeleteReservationDTO(UUID.randomUUID()))
        );
    }

    private static Stream<Arguments> generateInvalid(){
        return  Stream.of(
                Arguments.of(new DeleteReservationDTO(null)
                )
              );
    }
}
